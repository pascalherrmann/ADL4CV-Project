...
fid50k = dnnlib.EasyDict(func_name='metrics.frechet_inception_distance.FID', name='fid50k', num_images=4375, minibatch_per_gpu=8)
...
lm_hd = dnnlib.EasyDict(func_name='metrics.landmark_hausdorff.LMHausdorff', name='lm_hd', num_images=4375, minibatch_per_gpu=16)
csim = dnnlib.EasyDict(func_name='metrics.appearance_cosine_similarity.CSIM', name='csim', num_images=4375, minibatch_per_gpu=16)
