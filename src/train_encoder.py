...
E_loss          = EasyDict(func_name='training.loss_encoder.E_loss', feature_scale=0.00005, D_scale=0.5, perceptual_img_size=256)
...
minibatch_per_gpu_test  = {64: 8, 128: 8, 256: 2, 512: 1, 1024: 1}
