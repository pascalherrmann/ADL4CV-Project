...
ENCODER_PICKLE_DIR = "/content/gdrive/My Drive/Public/tensorboards_shared/run/15_both_encoder_conditional_discriminator/snapshots/network-snapshot-01300160.pkl"
# Encoder
