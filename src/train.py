...
if 1:
    desc          = 'sgan' + config.DESC                                                   # Description string included in result subdir name.
    ...
    # Dataset.
    desc += '-ffhq';     dataset = EasyDict(tfrecord_dir=config.DATA_DIR, resolution = config.RESOLUTION);                 train.mirror_augment = True
