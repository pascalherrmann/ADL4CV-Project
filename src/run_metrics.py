...
def main():
    ...
    tasks = []
    tasks += [EasyDict(run_func_name='run_metrics.run_pickle', network_pkl='/content/gdrive/My Drive/Public/tensorboards_shared/run/t/58_rignet_fixed_pose_only_larger_adv_scaling/snapshots/network-snapshot-01560192.pkl', dataset_args=EasyDict(tfrecord_dir='/content/gdrive/My Drive/Public/tensorboards_shared/split_dataset/test', shuffle_mb=0), mirror_augment=True)]
