...
def training_loop(
    ...
    for it in range(start, max_iters):
        ...
        feed_dict_1 = {placeholder_real_portraits_train: batch_portraits, placeholder_real_landmarks_train: batch_landmarks, placeholder_real_shuffled_test=batch_shuffled}
