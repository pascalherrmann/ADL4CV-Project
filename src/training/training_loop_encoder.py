...
def parse_tfrecord_tf(record):
    ...
    return [data, features['keypoints'][:69]]
...
def training_loop(
    ...
    with tf.name_scope('input'):
        ...
        placeholder_real_keypoints_test = tf.placeholder(tf.float32, [submit_config.batch_size_test, 69], name='placeholder_real_keypoints_test')
