...
#----------------------------------------------------------------------------
# Network Definition of Conditional Discriminator that takes images + landmark pictures as input.
# new: konkattenieren von bild + landmark und feeden in bestehenden discirminator.
